...
export const messages = {
  en: {
    ...
    alertsRangeReset: 'Reset to selected day',
    alertsRangeStartHint: 'Tap the first day to watch in the calendar below.',
    alertsRangeEndHint: 'Now tap the last day to watch. The same day again watches a single day.',
    alertsRangeCalendarHint: 'These dates come from the calendar below.',
    ...
    alertsTelegramHint: 'Tap Start in Telegram to finish. Send /stop there to unsubscribe.',
    alertsTelegramError: 'Could not create the Telegram link. Try again.',
  ...
  ru: {
    ...
    alertsRangeReset: 'Вернуть выбранный день',
    alertsRangeStartHint: 'Нажмите в календаре ниже первый день для отслеживания.',
    alertsRangeEndHint: 'Теперь нажмите последний день. Тот же день — отслеживание одного дня.',
    alertsRangeCalendarHint: 'Эти даты берутся из календаря ниже.',
    ...
    alertsTelegramHint: 'Нажмите «Start» в Telegram, чтобы завершить. Команда /stop отключит уведомления.',
    alertsTelegramError: 'Не удалось создать ссылку Telegram. Попробуйте еще раз.',
    alertsEmailLabel: 'Email',
  ...
  ua: {
    ...
    alertsRangeReset: 'Повернути вибраний день',
    alertsRangeStartHint: 'Натисніть у календарі нижче перший день для стеження.',
    alertsRangeEndHint: 'Тепер натисніть останній день. Той самий день — стеження за одним днем.',
    alertsRangeCalendarHint: 'Ці дати беруться з календаря нижче.',
    ...
    alertsTelegramHint: 'Натисніть «Start» у Telegram, щоб завершити. Команда /stop вимкне сповіщення.',
    alertsTelegramError: 'Не вдалося створити посилання Telegram. Спробуйте ще раз.',
    alertsEmailLabel: 'Email',
  ...
  ka: {
    ...
    alertsRangeReset: 'არჩეულ დღეზე დაბრუნება',
    alertsRangeStartHint: 'ქვემოთ კალენდარში აირჩიეთ პირველი სათვალთვალო დღე.',
    alertsRangeEndHint: 'ახლა აირჩიეთ ბოლო დღე. იგივე დღე ნიშნავს ერთი დღის თვალყურის დევნებას.',
    alertsRangeCalendarHint: 'ეს თარიღები მოდის ქვემოთ მოცემული კალენდრიდან.',
    ...
    alertsTelegramHint: 'დასასრულებლად Telegram-ში დააჭირეთ «Start». /stop გამორთავს შეტყობინებებს.',
    alertsTelegramError: 'Telegram-ის ბმულის შექმნა ვერ მოხერხდა. სცადეთ ხელახლა.',
